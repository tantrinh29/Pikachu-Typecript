...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".gameItem{\r\n    border: 1px solid #ddd;\r\n    border-radius: 5px;\r\n    box-shadow: 5px 10px 10px #e8f5ee;\r\n    height: 137px;\r\n    max-width: 169px;\r\n}\r\n.unmatched{\r\n    background-color: rgb(248, 0, 0);\r\n}\r\n.img-fluid{\r\n    max-width: 63%;\r\n}", "",{"version":3,"sources":["webpack://./src/frontend/style.css"],"names":[],"mappings":"AAAA;IACI,sBAAsB;IACtB,kBAAkB;IAClB,iCAAiC;IACjC,aAAa;IACb,gBAAgB;AACpB;AACA;IACI,gCAAgC;AACpC;AACA;IACI,cAAc;AAClB","sourcesContent":[".gameItem{\r\n    border: 1px solid #ddd;\r\n    border-radius: 5px;\r\n    box-shadow: 5px 10px 10px #e8f5ee;\r\n    height: 137px;\r\n    max-width: 169px;\r\n}\r\n.unmatched{\r\n    background-color: rgb(248, 0, 0);\r\n}\r\n.img-fluid{\r\n    max-width: 63%;\r\n}"],"sourceRoot":""}]);
// Exports
...
//tìm kiếm id app và trả về biến rootElement
const rootElement = document.querySelector('#app');
var gameApp = null; //khai báo biến gameApp có kiểu là GameController
if (rootElement) { //kiểm tra rootElement
    gameApp = new _controllers_GameController__WEBPACK_IMPORTED_MODULE_0__.GameController([
        ...
        new _models_GameItem__WEBPACK_IMPORTED_MODULE_1__.GameItem(8, '', '11.png'),
    ...
    gameApp.renderGameBoard(); //hiển thị thông tin của game
}
...
class GameController {
    constructor(items, element) {
        ...
        this.items = []; //luu danh sách các thanh phan trong game
    ...
    initGame(initData) {
        ...
        this.items.forEach(it => {
            it.status = _models_GameItem__WEBPACK_IMPORTED_MODULE_1__.GameItemStatus.Close; //xác định status của mỗi phần tử trong danh sách
    ...
    renderResetButton(rootElement) {
        let button = rootElement.querySelector('#reset');
        if (button) {
    ...
    processGameItemClicked(event) {
        ...
        for (const item of this.items) {
            if (item.divId == (element === null || element === void 0 ? void 0 : element.id) && !item.isMatched && item.status === _models_GameItem__WEBPACK_IMPORTED_MODULE_1__.GameItemStatus.Close) {
                item.status = _models_GameItem__WEBPACK_IMPORTED_MODULE_1__.GameItemStatus.Open; // đánh dấu thành phần được mở
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkassgamepikachu"] = self["webpackChunkassgamepikachu"] || [];
